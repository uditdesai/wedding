    ...
    <>
      <EventsContainer>
        <StartContainer>
          ...
          <EventTitle>Bride's Mehndi Night</EventTitle>
        </StartContainer>
        <ContentContainer>
          <BannerContainer>
            <DateContainer>
            ...
            <BannerImage src={Mehndi} />
          </BannerContainer>
          <ScheduleContainer>
            <ScheduleDescription>
              Mehndi laga ke rakhna! A musical night of singing wedding songs
              and getting your henna on!
            </ScheduleDescription>
            <Divider></Divider>
            <ScheduleTitle>Schedule</ScheduleTitle>
            <ScheduleWrapper>
              <TimeWrapper>
                <ScheduleTime>8:00pm</ScheduleTime>
                <ScheduleDesc>Mehndi Night begins!</ScheduleDesc>
              </TimeWrapper>
            </ScheduleWrapper>
          </ScheduleContainer>
          <LastColumn>
            ...
            <AttireContainer>
              ...
              <AttireText>Anything comfy!</AttireText>
            </AttireContainer>
          </LastColumn>
        </ContentContainer>
      </EventsContainer>
